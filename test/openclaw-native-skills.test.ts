...
const OPENCLAW_NATIVE_SKILLS = [
  'openclaw/skills/torch-openclaw-investigate/SKILL.md',
  'openclaw/skills/torch-openclaw-office-hours/SKILL.md',
  'openclaw/skills/torch-openclaw-ceo-review/SKILL.md',
  'openclaw/skills/torch-openclaw-retro/SKILL.md',
];

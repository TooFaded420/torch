 ...
 * for our seeded fixture (the agent would review the torch PR itself,
...
const PLAN_CEO_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/torch-test-plan-ceo.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_CEO_2_PAIRED_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/torch-test-plan-ceo-paired.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_CEO_PATH = '/tmp/torch-test-plan-ceo.md';
const PLAN_CEO_PAIRED_PATH = '/tmp/torch-test-plan-ceo-paired.md';

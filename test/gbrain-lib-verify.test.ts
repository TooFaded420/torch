/**
 * torch-gbrain-supabase-verify + torch-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by torch-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'torch-gbrain-supabase-verify');
...
describe('torch-gbrain-supabase-verify', () => {
  const VALID =
...
describe('torch-gbrain-lib.sh read_secret_to_env', () => {

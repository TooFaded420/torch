...
- Save the report to .torch/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.torch', 'security-reports');
...
- Skip the preamble (torch-update-check, telemetry, etc.) — go straight to the audit.

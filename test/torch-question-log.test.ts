/**
 * bin/torch-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'torch-question-log');
...
describe('torch-question-log — valid payloads', () => {
...
describe('torch-question-log — rejected payloads', () => {
...
describe('torch-question-log — injection defense', () => {
  const attacks = [
...
describe('torch-question-log — shared injection patterns (#1934 dedup)', () => {

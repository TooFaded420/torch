/**
 * Contract tests for bin/torch-redact — exit codes, JSON shape, flags,
...
const BIN = path.resolve(import.meta.dir, "..", "bin", "torch-redact");
...
describe("torch-redact exit codes", () => {
  test("clean → 0", () => {
...
describe("torch-redact --auto-redact", () => {
...
describe("torch-redact --allowlist", () => {
...
describe("torch-redact --self-email", () => {
...
describe("torch-redact --from-file", () => {
...
describe("torch-redact oversize fails closed", () => {

/**
 * torch-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'torch-model-benchmark');
...
describe('torch-model-benchmark prompt resolution', () => {

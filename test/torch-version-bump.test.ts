/**
 * Tests for the torch-version-bump CLI (v2 plan T9 hybrid extraction). Covers
...
import { classifyState, VERSION_RE } from '../bin/torch-version-bump';

const BIN = path.join(import.meta.dir, '..', 'bin', 'torch-version-bump');

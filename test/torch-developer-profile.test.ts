/**
 * bin/torch-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'torch-test-'));
});
...
describe('torch-developer-profile --read', () => {
...
describe('torch-developer-profile --migrate', () => {
...
describe('torch-developer-profile tier calculation', () => {
...
describe('torch-developer-profile --derive', () => {
...
describe('torch-developer-profile --trace <dim>', () => {
...
describe('torch-developer-profile --gap', () => {
...
describe('torch-developer-profile --vibe', () => {
...
describe('torch-developer-profile --check-mismatch', () => {
...
describe('torch-developer-profile errors', () => {
...
describe('torch-developer-profile --log-session (#1671 fix)', () => {
  ...
  test('silently skips invalid JSON input (matches torch-timeline-log pattern)', () => {

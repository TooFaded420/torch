...
describe("torch-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    ...
    test("SSH and HTTPS for same repo normalize to same URL", () => {
      const ssh = normalizeRemoteUrl("git@github.com:TooFaded420/torch.git");
      const https = normalizeRemoteUrl("https://github.com/TooFaded420/torch.git");
      const httpsNoDotGit = normalizeRemoteUrl("https://github.com/TooFaded420/torch");

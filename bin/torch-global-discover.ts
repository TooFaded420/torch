#!/usr/bin/env bun
/**
 * torch-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   torch-global-discover --since 7d [--format json|summary]
 *   torch-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: torch-global-discover --since <window> [--format json|summary]
...
Examples:
  torch-global-discover --since 7d
  torch-global-discover --since 14d --format summary`);
}

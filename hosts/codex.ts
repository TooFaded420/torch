...
const codex: HostConfig = {
  ...
  pathRewrites: [
    ...
    { from: '.claude/skills/torch', to: '.agents/skills/torch' },
    { from: '.claude/skills/review', to: '.agents/skills/torch/review' },

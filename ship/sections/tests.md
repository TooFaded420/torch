...
`~/.claude/skills/torch/bin/torch-detach` instead — it survives in its own
...
```bash
~/.claude/skills/torch/bin/torch-detach --label ship-evals --lock torch-evals --timeout 5400 -- <project eval command>
```

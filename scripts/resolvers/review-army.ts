 ...
 * 1. Detect stack and scope (via torch-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/torch-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/torch-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/torch-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`

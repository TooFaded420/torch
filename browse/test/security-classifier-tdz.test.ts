...
describe('security-classifier: missing claude CLI degraded path', () => {
  ...
  afterEach(() => {
    ...
    if (origtorchClaudeBin !== undefined) process.env.torch_CLAUDE_BIN = origtorchClaudeBin;

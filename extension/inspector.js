/**
 * torch browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__torchInspectorActive) return;
  window.__torchInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'torch-inspector-highlight';
    ...
    tooltipEl.id = 'torch-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'torch-inspector-highlight' || target.id === 'torch-inspector-tooltip') return;

...
├── open-torch-browser/  # /open-torch-browser skill (launch GStack Browser)
...
1. **Touches ETHOS.md** — this file is the upstream builder philosophy. No edits
...
3. **Changes the voice** — the tone, humor, directness, and perspective in skill

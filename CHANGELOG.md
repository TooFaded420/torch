...
## torch v0.1.0 — forked from gstack — 2026-04-17

- Forked from garrytan/gstack v0.18.3.0
- Rebranded: `gstack` -> `torch` across all commands, state dir, env vars
...
[Upstream gstack changelog preserved below for historical reference.]

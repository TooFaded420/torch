...
## Product Context
- **What this is:** Community website for torch — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering torch, existing community members

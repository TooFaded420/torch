...
- torch installed (`git clone --single-branch --depth 1 https://github.com/garrytan/gstack.git ~/.claude/skills/torch && cd ~/.claude/skills/torch && ./setup`)
...
- **If you want to understand why the four quadrants exist:** read [explanation-diataxis-in-torch.md](./explanation-diataxis-in-torch.md).

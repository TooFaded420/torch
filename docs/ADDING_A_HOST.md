# Adding a New Host to torch

torch uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/torch',
  localSkillRoot: '.myhost/skills/torch',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/torch', to: '~/.myhost/skills/torch' },
    { from: '.claude/skills/torch', to: '.myhost/skills/torch' },
...
ls .myhost/skills/torch-*/SKILL.md
